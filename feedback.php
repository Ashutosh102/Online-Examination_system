...
<style>
  body{
    background-image: url("image/30318.jpg");
...
<div class="col-lg-6">
<span class="logo">OnlineExam</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="bg1" style="border: 7px solid gold;
border-radius: 10px;">
<div class="row">
<div class="col-md-3"></div>
<div class="col-md-6 panel" style="background-color:rgba(255, 255, 255, 0.561); min-height:430px;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
    <img src="image/tony_ashu.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
            </div>
            <div class="col-md-5">
              <a href="http://github.com/Ashutosh102" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ashutosh Mohanty</a>
              <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7749067820</h4>
              <h4 style="font-family:'typo' ">ashutoshmoanty3815@gmail.com</h4>
              <h4 style="font-family:'typo' ">GIET University, Gunupur</h4></div></div>
		</p>
      </div>
